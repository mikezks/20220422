...
import { cloneRouteReturnWithEmptyChildren, moduleWithProjectedRoutes, projectedRoutesProvider } from '@projected-routes/shared/util-projected-routes';
...
export class TrefferlistFeatureCommonModule {
  static withProjectedRoutes = moduleWithProjectedRoutes(
    ...
    cloneRouteReturnWithEmptyChildren(routes[0])
  );
}
